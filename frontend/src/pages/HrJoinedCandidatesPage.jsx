...
const HrJoinedCandidatesPage = () => {
  ...
  const fetchCandidates = async () => {
    const { data } = await api.get("/hr-calling-data/joined-candidates");
    ...
    <div className="appointments-page">
      <div className="appointments-card">
        <div className="appointments-header">
          <div>
            <h2 className="appointments-title">Joined Candidates</h2>
            <p className="appointments-subtitle">
              Candidates marked as joined after scheduled interview
            </p>
          </div>
        </div>
        ...
        <div className="appointments-summary-card">
          <div>
            <h3>Joined Records</h3>
            <p>Total candidates marked as joined</p>
          </div>
                  ...
                  <tr key={item._id}>
                    ...
                    <td>
                      <textarea
                        value={item.notes || ""}
                        onChange={(e) =>
                          handleNotesChange(item._id, e.target.value)
                        }
